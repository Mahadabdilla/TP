...
namespace WebIMmobilier.Controllers
{
    public class MaisonViewModelsController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            MaisonViewModel maisonViewModel = null;// db.biens.Find(id);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdBien,DescriptionBien,SuperficieBien,LocaliteBien,IdProprio,NbreChambre,NbreSalleEau,NbreCuisine,NbreToilette")] MaisonViewModel maisonViewModel)
        {
            if (ModelState.IsValid)
            {
