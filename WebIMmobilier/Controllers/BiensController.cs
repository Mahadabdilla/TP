...
namespace WebIMmobilier.Controllers
{
    public class BiensController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdBien,DescriptionBien,SuperficieBien,LocaliteBien,IdProprio")] Bien bien)
        {
            ...
            ViewBag.IdProprio = new SelectList(db.utilisateurs, "IdUtilisateur", "NomUtil", bien.IdProprio);
            return View(bien);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdBien,DescriptionBien,SuperficieBien,LocaliteBien,IdProprio")] Bien bien)
        {
            if (ModelState.IsValid)
            {
