...
namespace WebIMmobilier.Controllers
{
    public class TerrainsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdBien,DescriptionBien,SuperficieBien,LocaliteBien,IdProprio,TypeTerrain")] Terrain terrain)
        {
            ...
            ViewBag.IdProprio = new SelectList(db.utilisateurs, "IdUtilisateur", "NomUtil", terrain.IdProprio);
            return View(terrain);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdBien,DescriptionBien,SuperficieBien,LocaliteBien,IdProprio,TypeTerrain")] Terrain terrain)
        {
            if (ModelState.IsValid)
            {
