...
namespace WebIMmobilier.Controllers
{
    public class AppartementsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdBien,DescriptionBien,SuperficieBien,LocaliteBien,IdProprio,NbreSalle")] Appartement appartement)
        {
            ...
            ViewBag.IdProprio = new SelectList(db.utilisateurs, "IdUtilisateur", "NomUtil", appartement.IdProprio);
            return View(appartement);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdBien,DescriptionBien,SuperficieBien,LocaliteBien,IdProprio,NbreSalle")] Appartement appartement)
        {
            if (ModelState.IsValid)
            {
